...
- [x] **Seamless Wall Connections**:
    ...
    - [x] **Stray Wall Fix**: Added UI-level (>10cm) and Store-level (>5cm) guardrails and double-click termination.
    - [x] **Robust Splitting**: Fixed a bug where segments were dropped during auto-splitting and consolidated logic in the store.
